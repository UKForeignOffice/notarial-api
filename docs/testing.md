...
To run the integration tests in headless mode, use the scripts provided by the integration-test project.

Use that project's Cypress UI script to run the integration tests interactively.