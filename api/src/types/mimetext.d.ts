/**
 *  Taken from https://github.com/muratgozel/MIMEText/blob/master/types/index.d.ts
 *  Declaration file is not recognised by ts due to commonjs vs ES modules madness,
 *  so we need to declare the types ourselves in the project.
 */
declare module "mimetext" {
  ...
  export interface MIMEMessage {
    ...
    setRecipients(
      input: MailboxAddrObject | MailboxAddrText | Email | MailboxAddrObject[] | MailboxAddrText[] | Email[],
