...
import { GetTemplateCommand, SendRawEmailCommand, SESClient, Template } from "@aws-sdk/client-ses";
...
export class SESService {
  ...
  async sendEmail(message: string) {
    try {
      ...
      return this.handleSESError(err as Error);
    }
  }
